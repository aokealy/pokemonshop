...
- Welcome to my Project 5 Eccomerce store where I created a Pokemon Shop since I am a passionate fan of Pokemon and wanted to try and create my very own store where other pokemon fans can access and enjoy looking at only pokemon items that they can purchase and look and see some rare cards that are hard to find. In this project I demostrate a payment system using Paypal and use CRUD functionallity for users to be able to update and delete items and also create profile, update profile and delete profile! :)
The main purpose of this project is to create a Ecommerce platform and to show my users a great Pokemon website where users will be able to buy rare cards which are hard to come by and make the website super friendly and easy to read and navigate through!
...
## Test Login (working)
- User to be able to login - Expected Result - User redirected to Pokemon Hun after login form (working) 
- User to login after registration - Expected Result - User can enter login details and be redirected (working)
- User to be able to login with username and password - Expected Result - User to enter correct username and password to login (working)
- User to be able to go to register page from login page - Expected Result - User can click link to redirect to register form (working)
- User will get message saying user has logged in successfully - Expected Result - Django message will activate after user has logged in (working)
- User to be able to have access to features only for login users - Expected Result - Navbar should change to features after loggin in (working)
## Test Logout (working)
